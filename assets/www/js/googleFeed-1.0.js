...
var _UDS_MSG_SEARCHCONTROL_SPONSORED_LINKS = ('Enlaces patrocinados');
...
function _UDS_MSG_MINUTES_AGO(AGE_MINUTES_AGO) {return ('hace ' + AGE_MINUTES_AGO + ' minutos');}
var _UDS_MSG_ONE_HOUR_AGO = ('hace 1 hora');
function _UDS_MSG_HOURS_AGO(AGE_HOURS_AGO) {return ('hace ' + AGE_HOURS_AGO + ' horas');}
function _UDS_MSG_NEWS_ALL_N_RELATED(NUMBER) {return ('y ' + NUMBER + ' art\u00edculos relacionados');}
...
function _UDS_MSG_LOCAL_ATTRIBUTION(LOCAL_RESULTS_PROVIDER) {return ('Directorios empresariales proporcionados por ' + LOCAL_RESULTS_PROVIDER);}
...
var _UDS_MSG_BACK = ('atr\u00e1s');
var _UDS_MSG_SUBSCRIBE = ('Suscribirse');
var _UDS_MSG_SEARCHER_PATENT = ('Patente');
var _UDS_MSG_USPAT = ('Patente estadounidense');
var _UDS_MSG_USPAT_APP = ('Solicitud de patente estadounidense');
var _UDS_MSG_PATENT_FILED = ('Presentado');
var _UDS_MSG_ADS_BY_GOOGLE = ('Anuncios Google');
var _UDS_MSG_SET_DEFAULT_LOCATION = ('Definir ubicaci\u00f3n predeterminada');
var _UDS_MSG_NEWSCAT_TOPSTORIES = ('Noticias destacadas');
var _UDS_MSG_NEWSCAT_WORLD = ('Internacional');
var _UDS_MSG_NEWSCAT_NATION = ('Nacional');
var _UDS_MSG_NEWSCAT_BUSINESS = ('Econom\u00eda');
var _UDS_MSG_NEWSCAT_SCITECH = ('Ciencia/Tecn.');
var _UDS_MSG_NEWSCAT_ENTERTAINMENT = ('Espect\u00e1culos');
var _UDS_MSG_NEWSCAT_HEALTH = ('Salud');
var _UDS_MSG_NEWSCAT_SPORTS = ('Deportes');
var _UDS_MSG_NEWSCAT_POLITICS = ('Pol\u00edtica');
var _UDS_MSG_SEARCH_RESULTS = ('Resultados de b\u00fasqueda');
var _UDS_MSG_DID_YOU_MEAN = ('Quiz\u00e1s quisiste decir:');
var _UDS_MSG_CUSTOM_SEARCH = ('B\u00fasqueda personalizada de Google');
var _UDS_MSG_LABELED = ('Etiquetado');
var _UDS_MSG_LOADING = ('Cargando...');
var _UDS_MSG_ALL_RESULTS_SHORT = ('Todos');
var _UDS_MSG_ALL_RESULTS_LONG = ('Todos los resultados');
var _UDS_MSG_REFINE_RESULTS = ('Restringir resultados:');
function _UDS_MSG_REVIEWS(REVIEW_COUNT) {return ('' + REVIEW_COUNT + ' opiniones');}
function _UDS_MSG_CALORIES(CALORIES) {return ('' + CALORIES + ' cal');}
function _UDS_MSG_PRICE_RANGE(RANGE) {return ('Intervalo de precios: ' + RANGE + '.');}
function _UDS_MSG_PRICE(PRICE) {return ('Precio: ' + PRICE + '.');}
function _UDS_MSG_AVAILABILITY(AVAILABILITY) {return ('Disponibilidad: ' + AVAILABILITY + '.');}
...
var _UDS_MSG_FILE_FORMAT = ('Formato de archivo:');
var _UDS_MSG_SHOWING_RESULTS_FOR = ('Mostrando resultados de');
var _UDS_MSG_SEARCH_INSTEAD_FOR = ('Buscar en su lugar');
function _UDS_MSG_FILTERED_RESULTS(NUM) {return ('Para mostrarte los resultados m\u00e1s relevantes, hemos omitido algunas entradas muy similares a las ' + NUM + ' entradas ya mostradas. Si quieres, puedes ' + '<a>repetir la b\u00fasqueda incluyendo los resultados omitidos' + '</a>.');}
var _UDS_MSG_ORDER_BY = ('Ordenar por:');
var _UDS_MSG_ORDER_BY_RELEVANCE = ('Relevancia');
var _UDS_MSG_ORDER_BY_DATE = ('Fecha');
